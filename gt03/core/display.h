...
private:
    ...
    const uint8_t DC_PIN = LCD_DC_PIN;
    const uint8_t CS_PIN = LCD_CS_PIN;
    const uint8_t SCK_PIN = LCD_CLK_PIN;
    const uint8_t MOSI_PIN = LCD_MOSI_PIN;
    const uint8_t RST_PIN = LCD_RST_PIN;
    const uint8_t BL_PIN = LCD_BKL_PIN;
